...
function RegisterPage() {
    ...
    const register = async (e) => {
        ...
        if (response.status === 200) {
            ...
            alert('There seems to be an error with the registration');
        }
        ...
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div className="max-w-md mx-auto">
                    <div>
                        <h1 className="text-2xl font-semibold">Register to BlogIt</h1>
                    </div>
                    <div className="divide-y divide-gray-200">
                        <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div className="relative">
                                <button className="bg-blue-500 text-white rounded-md px-2 py-1" onClick={e => register(e)}>Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
